...
def pytest_addoption(parser):
    parser.addoption('--browser_language', action='store', default=None, help="Choose language, please")
...
def browser(request):
    ...
    if browser_language is None:
        raise pytest.UsageError("Please select language with --browser_language option.")
    else:
        options = Options()
